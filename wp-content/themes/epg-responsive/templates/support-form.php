<div class="epg_form_wrap">
    <form enctype="multipart/form-data" onsubmit="return validate()" method="POST" name="MyForm" action="">
        ...
        <div class="innerwrap">
	        ...
	        <h3>Name:</h3>
			<p>
				<input autofocus class="floatlabel full-width" type="text" maxLength="29" name="employee" placeholder="Enter your name" ></p>
	        ...
	        <h3>Subject:</h3>
	        <p>
		        <input class="floatlabel full-width" type="text" maxLength="35" name="shortReason" placeholder="What is the issue?" data-label="Short description of request (Limit 35 characters)"></p>
	        ...
	        <p>
		        <textarea name="reason" placeholder="Please describe the issue" class="floatlabel"></textarea></p>
